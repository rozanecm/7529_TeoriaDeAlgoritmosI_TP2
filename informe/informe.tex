...
\item \textt{lein bfs} ejecutar de forma interactiva el algoritmo para grafos sin pesos
\item \textt{lein dijkstra} ejecutar de forma interactiva el programa para grafos con pesos
\item \textt{lein test} ejecutar los test
